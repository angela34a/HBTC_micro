...
\<\<\<\<\<\<\< HEAD Since there is no clear significant difference shown by group, we will try to see if there is a linear trend.
...
ggplot(aes(x = Mean_CH4 , y = abund)) +
  ...
  stat_poly_eq(use_label(c( "adj.R2", "p")), 
               ...
               size = 3) +
  labs(y="Abundances (absolute 16S counts)",
       x= "Mean methame levels")

```

# Temperature-related abundance trends

After looking at alpha diversity for the temperature categories, and compositional differences per temperature categoires at class level, here there is more mining for trends at lower taxonomic levels.
