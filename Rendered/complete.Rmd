...
For the spring campaign, additional categorizations and measurements were performed, so the subset is not only constrained to the DS aquifer type, but also to only the spring samples.

There is now the information on the wastewater impact, redox phase and heat source effect for each sample.
...
## Diversity in relation to env vars
