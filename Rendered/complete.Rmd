...
Communities of high temperature samples are more dispersed (more dissimilar between themselves) tham the cold and average-temperature samples.
...
High temperature samples vary in most of the measured variables, while te extremely cold samples mostly differ along the pH spectrum.
...
The third PC conists of the well depth variation.
...
There is now the information on the wastewater impact, redox phase and heat source effect for each sample, as well as heavy metal measurements.
...
One final check with all the variablesn and only the DS subset.
