...
=======
To perform ANOVA the assumption of normality and homoscedasticity were checked.
>>>>>>> 7edbdbc546e9093dc1703d8182c096c98b6a06e4
=======
To perform ANOVA the assumption of normality and homoscedasticity were checked.
>>>>>>> 7edbdbc546e9093dc1703d8182c096c98b6a06e4
...
=======
Since there is no clear significant difference shown by group, we willtry to see if there is a linear trend.
>>>>>>> 7edbdbc546e9093dc1703d8182c096c98b6a06e4
=======
Since there is no clear significant difference shown by group, we willtry to see if there is a linear trend.
>>>>>>> 7edbdbc546e9093dc1703d8182c096c98b6a06e4
...
Let's see if there is a better fit of multiple regression:
...
ggplot(aes(x = temp_cat , y = abund)) +
  ...
  theme(legend.position = "none") + 
  labs(y = "Abundance (counts from the sequencing)",
       x = "Temperature")

```

When looking at the groups there is still an upwards trend in the Candidatus Roizmanbacteria, butnow there is also significant difference in the Desulfobacterales order.
